...
public class Session {
  ...
  * @return accessToken
  **/
  @Schema(description = "The consumer’s access token key")
  ...
  * @return nonce
  **/
  @Schema(description = "Random string, uniquely generated by the proxy")
  ...
  * @return signature
  **/
  @Schema(description = "Checksum generated by hmac-sha1 of accessToken + device.serialNumber + endpointId + nonce + invoiceId + amountCentis + currency")
  ...
  * @return token
  **/
  @Schema(description = "The session token of transfer transaction")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(accessToken, nonce, signature, token);
  }
